...
from darmilibs.darmi.helper.basic import edit_or_reply, get_text, get_user

from Darmi.modules.basic.help import add_command_help
from Darmi import cmds

OWNER = os.environ.get("OWNER", None)
BIO = os.environ.get("BIO", "Darmi Pyro Userbot")
