...
from darmilibs.darmi.helper.data import Data
from darmilibs.darmi.helper.inline import inline_wrapper, paginate_help
from darmilibs import BOT_VER, __version__ as gver
from Darmi import CMD_HELP, StartTime, app

photo = "https://telegra.ph/file/80ddddfcd915d468bdb1a.png"
...
<b> • darmilibs Version :</b> <code>{gver}</code>
...
"""
    answers.append(
        InlineQueryResultArticle(
            ...
            thumb_url="https://telegra.ph/file/80ddddfcd915d468bdb1a.png",
...
async def ping_function(message: Message, answers):
    ...
    answers.append(
        InlineQueryResultArticle(
            ...
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton("Support", url="t.me/darmiRam")]]
            ),
        )
    )
    return answers
